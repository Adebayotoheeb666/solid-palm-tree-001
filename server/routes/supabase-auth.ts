...
// Create default admin user in Supabase (handled by DatabaseInitializer)
const createSupabaseAdminUser = async () => {
  // Admin user creation is now handled by DatabaseInitializer
  // to provide better error handling and initialization
  console.log("ℹ️ Admin user creation delegated to DatabaseInitializer");
};

// Skip admin user creation on startup (handled by DatabaseInitializer)
